...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Hans 👋 — a web developer who loves building fast, clean, and high-converting websites.",
        "I specialize in creating smooth, optimized, and visually appealing sites using WordPress and Shopify. Whether it’s crafting a custom theme, fixing a stubborn bug, or improving performance, I enjoy turning messy problems into simple, scalable solutions.",
        "I’m also big on automation and AI — from building smart workflows to experimenting with AI agents that make life (and business) a whole lot easier. If there’s a task I can automate, trust me… it won’t stay manual for long.",
        "Outside of coding, I live a pretty active life. I’m a runner who’s always up before sunrise for training runs, and you’ll often find me joining races on weekends.",
        "And yes — when I’m not running or coding, I’m busy being a hamster dad to 20+ adorable Dwarf and Syrian hamsters 🐹✨ (they run more than I do, to be honest).",
        "I love learning, building, and experimenting with anything that helps me grow as a developer — and I’m always working on the next project that gets me excited."
      ],
    },
  ],
};
